                            ...
                            <div className="mt-12 text-center">
                                <div className="inline-flex items-center bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
                                    ...
                                    <p className="text-amber-800">
                                        Por favor, <Link href="/login" className="font-semibold underline">faça login</Link> ou <Link href="/register" className="font-semibold underline">crie uma conta</Link> para se inscrever
                                    </p>
                                </div>
                            </div>
                        )}
